...
public final class MonetaryFormat {
    ...
    /** Standard format for the µDGBdenomination. */
    ...
    /** Currency code for base 1/1000 DigiByte. */
    public static final String CODE_MDGB = "mDGB";
    /** Currency code for base 1/1000000 DigiByte. */
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard DGB notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_DGB;
        this.codes[3] = CODE_MDGB;
        this.codes[6] = CODE_UDGB;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.digibytej.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.digibytej.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
