 ...
 * String c = f.format(Coin.COIN);                <strong>// "DGB 1.00"</strong>
 * String k = f.format(Coin.COIN.multiply(1000)); <strong>// "DGB 1,000.00"</strong>
 ...
 * code, such as <code>"DGB"</code>, to indicate the units of denomination, while the
 * <code>SYMBOL</code> style uses a possibly-ambiguous currency symbol such as
 * <code>"฿"</code>.
 *
 * <p>The denomination used when formatting will be either digibyte, millicoin
 ...
 * locale, a value of one digibyte might be formatted as <pre>฿1.00</pre> where a value
 ...
 * <code>1.0000 DGB</code>, or one digibyte, in millibitcoins, one shifts the decimal point
 ...
 * <blockquote><pre>
 * BtcFormat f = BtcFormat.getInstance();
 * String s = f.format(Coin.COIN); <strong>// "DGB 1.00"</strong>
 * </pre></blockquote>
 *
 ...
 * differently the same one-digibyte value:
 *
 * <blockquote><pre>
 * <strong>// Next line returns "1,00 DGB"</strong>
 ...
 * method.  This argument can be either a {@link org.digibytej.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /** The conventional international currency code for bitcoins: "DGB" */
     ...
     * currency code, for example "<code>DGB</code>", to indicate that denomination.  The
    ...
    /**
     * Return a new auto-denominating instance that will indicate units using a currency
     * code, for example, <code>"DGB"</code>.  Formatting and parsing will be done
     * according to the default locale.
     */
     ...
     * <code>"DGB"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.  Formatting and parsing will be done according to the default
     * locale.
     */
     ...
     * "<code>DGB</code>", or symbol, such as "<code>฿</code>", depending on the value
    ...
    /**
     * Formats a digibyte monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a digibyte value as a number and possibly a units indicator and appends the
    ...
    /**
     * Formats a digibyte value as a number and possibly a units indicator to a
    ...
    /**
     * Takes a digibyte monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a digibyte quantity of any type the
    ...
    /**
      ...
      * {@link org.digibytej.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
