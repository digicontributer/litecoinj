 ...
 * digibytej for a specific network. You can get an instance of this class through calling {@link #get()}.</p>
 *
...
public class Context {
    ...
    public Context(NetworkParameters params) {
        log.info("Creating digibytej {} context.", VersionMessage.BITCOINJ_VERSION);
     ...
     * independently use digibytej (or possibly alt coin forks of it) can operate correctly.
     *
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link org.digibytej.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link org.digibytej.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * Returns the {@link org.digibytej.core.NetworkParameters} specified when this context was (auto) created. The
