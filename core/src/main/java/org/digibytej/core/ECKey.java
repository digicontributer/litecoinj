...
import org.digibyte.NativeSecp256k1;
import org.digibyte.NativeSecp256k1Util;
import org.digibyte.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.digibytej.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.digibytej.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link org.digibytej.core.DumpedPrivateKey#toString()} method to get the string.
     *
