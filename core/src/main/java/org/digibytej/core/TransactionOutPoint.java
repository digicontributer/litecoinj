...
public class TransactionOutPoint extends ChildMessage {
    ...
    // This is not part of digibyte serialization. It points to the connected transaction.
    Transaction fromTx;
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(org.digibytej.wallet.KeyBag)} and then get the
     * key from RedeemData.
