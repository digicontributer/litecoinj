...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of digibytej fixes the known
     ...
     * {@link org.digibytej.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.digibytej.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.digibytej.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.digibytej.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.digibytej.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.digibytej.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.digibytej.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.digibytej.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.digibytej.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a digibytej based app running in SPV mode to fully validating security.
     */
