...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.digibyte.regtest";
    /** Unit test network. */
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.digibytej.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.digibytej.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.digibytej.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.digibytej.core.AlertMessage}s. You can use {@link org.digibytej.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
    ...
    /**
     * Scheme part for URIs, for example "digibyte".
     */
