...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/digibytej:" + BITCOINJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for digibytej
     * users might look like "/digibytej:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/digibytej:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
