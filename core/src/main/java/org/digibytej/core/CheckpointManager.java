 ...
 * {@link org.digibytej.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with digibytej */
    ...
    /** Returns a checkpoints stream pointing to inside the digibytej JAR */
