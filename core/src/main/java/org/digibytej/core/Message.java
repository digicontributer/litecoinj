...
public abstract class Message {
    ...
    /**
     * Serialize this message to a byte array that conforms to the digibyte wire protocol.
     * <br/>
    ...
    /**
     * Serialize this message to the provided OutputStream using the digibyte wire format.
     *
     * @param stream
     * @throws IOException
     */
