 ...
 * {@link org.digibytej.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.digibytej.crypto.MnemonicCode},
 ...
 * {@link org.digibytej.crypto.DeterministicKey#serializePubB58(org.digibytej.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.digibytej.crypto.DeterministicKey#deserializeB58(org.digibytej.crypto.DeterministicKey, String, org.digibytej.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.digibytej.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.digibytej.crypto.DeterministicHierarchy} and
 * {@link org.digibytej.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from digibytej users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.digibytej.crypto.DeterministicKey)}
