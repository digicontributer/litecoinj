...
import org.digibytej.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.digibytej.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.digibytej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.digibytej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.digibytej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.digibytej.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.digibytej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.digibytej.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.digibytej.wallet.KeyChain.KeyPurpose)} with
     * {@link org.digibytej.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of digibytej. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.digibytej.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.digibytej.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.digibytej.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.digibytej.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.digibytej.crypto.KeyCrypter,
     ...
     * {@link org.digibytej.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.digibytej.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.digibytej.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    /**
     * Returns the amount of digibyte ever received via output. <b>This is not the balance!</b> If an output spends from a
    ...
    /**
     * Returns the amount of digibyte ever sent via output. If an output is sent to our own wallet, because of change or
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.digibytej.signers.TransactionSigner.MissingSignatureException}
