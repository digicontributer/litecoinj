...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link org.digibytej.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the digibytej protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.digibytej.core.BloomFilter#BloomFilter(int, double, long)} for a brief
