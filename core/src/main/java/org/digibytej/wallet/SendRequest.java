...
import org.digibyte.protocols.payments.Protos.PaymentDetails;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.digibytej.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.digibytej.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
