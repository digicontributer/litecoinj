...
/**
 * Network parameters used by the digibytej unit tests (and potentially your own). This lets you solve a block using
 * {@link org.digibytej.core.Block#solve()} by setting difficulty to the easiest possible.
 */
