...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link org.digibytej.core.NetworkParameters}.
     ...
     *
     * <p>The balance {@link org.digibytej.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns
