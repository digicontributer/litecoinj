...
import org.digibytej.net.ProtobufConnection;
import org.digibytej.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
...
public class PaymentChannelClientConnection {
     ...
     * {@link org.digibytej.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
     ...
     * Attempts to open a new connection to and open a payment channel with the given host and port, blocking until the
     * connection is open.  The server is requested to keep the channel open for
     * {@link org.digibytej.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW} seconds.
