...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/digibyte-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/digibyte-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/digibyte-paymentack";
