 ...
 * transactions to the digibyte network. Instead it returns a ListenableFuture that will be notified when a
...
public class PaymentSession {
     ...
     * NOTE: This does not broadcast the transactions to the digibyte network, it merely sends a Payment message to the
