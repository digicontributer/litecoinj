...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.digibytej.core.PeerFilterProvider}s, a merged
 * {@link org.digibytej.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.digibytej.core.PeerGroup} class internally.</p>
 *
