 ...
 *
 * <ul>
 * <li>{@code digibyte:<address>}</li>
 * <li>{@code digibyte:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.digibytej.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.digibytej.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  digibyte:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form digibyte://address?....
        // We support both until Ben fixes his code.
        
        // Remove the digibyte scheme.
        // (Note: getSchemeSpecificPart() is not used as it unescapes the label and parse then fails.
        // For instance with : digibyte:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the digibyte: prefix");
     ...
     *         10,000,000 units is 1 DGB. May be null if no amount is specified
     */
