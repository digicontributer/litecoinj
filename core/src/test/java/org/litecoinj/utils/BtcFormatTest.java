...
public class BtcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        assertEquals(valueOf(200000000), us.parseObject("2"));
        assertEquals(valueOf(200000000), usCoded.parseObject("DGB 2"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("DGB 1.00"));
        ...
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MDGB 1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        assertEquals("DGB 1.00", usCoded.format(COIN));
        ...
        assertEquals("1,00 DGB", frCoded.format(COIN));
        ...
        assertEquals("DGB 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("DGB 1", codedZero.format(COIN));
        ...
        assertEquals("DGB 1,000", codedZero.format(COIN.multiply(1000)));
        ...
        assertEquals("DGB 1.00", codedTwo.format(COIN));
        ...
        assertEquals("DGB 1,000.00", codedTwo.format(COIN.multiply(1000)));
        ...
        assertEquals("DGB 1.000", codedThree.format(COIN));
        ...
        assertEquals("DGB 1,000.000", codedThree.format(COIN.multiply(1000)));
    ...
    public void symbolsCodesTest() {
        ...
        BtcFixedFormat symbolCoin = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(0).
                                                              symbol("B\u20e6").build();
        assertEquals("DGB", symbolCoin.code());
        ...
        BtcFixedFormat symbolMega = (BtcFixedFormat)BtcFormat.builder().locale(US).scale(-6).
                                                              symbol("B\u20e6").build();
        assertEquals("MDGB", symbolMega.code());
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 DGB", BtcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("DGB -1,00", BtcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("฿ -1,00", BtcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("DGB -1.00", BtcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("฿-1.00", BtcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(DGB 1.00)", BtcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(฿1.00)", BtcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("DGB -१.००", BtcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("DGB -๑.๐๐", BtcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("DGB") && ! codePat.contains("(^|[^฿])฿([^฿]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = BtcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("฿") && !symPat.contains("DGB") && !symPat.contains("¤¤"));

        assertEquals("DGB #,##0.00;(DGB #,##0.00)", BtcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format DGB #,##0.00;(DGB #,##0.00)", BtcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format DGB #,##0.0000;(DGB #,##0.0000)", BtcFormat.getCodeInstance(Locale.US, 4).toString());
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format DGB #.000;DGB -#.000", f.toString());
    ...
    public void builderTest() {
        ...
        assertEquals("DGB -1,00", built.format(COIN.multiply(-1)));
