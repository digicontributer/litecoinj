...
// This file shows how to use digibytej from Javascript.
// To run, grab the digibytej bundled JAR and then do something like this:
//
//   jjs -cp digibytej-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp digibytej-0.12-bundled.jar
//
...
//
//   jjs -cp digibytej-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And digibytej is a threaded library. This means you
